export default function Modules() {
    return (
        <div>
            ...
            <button id="wd-btn-collapse" type="button">Collapse All</button>
             <button id="wd-btn-progress" type="button">View Progress</button> 
            ...
            <ul id="wd-modules">
                <li className="wd-module">
                    <div className="wd-title">
                        Week 1 - Course Introduction, Syllabus, Agenda, Internet, Web, HTML,
                        Assignment 1
                    </div>
